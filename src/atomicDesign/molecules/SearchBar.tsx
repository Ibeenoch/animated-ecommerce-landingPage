  ...
  return (
    <div className='bg-[#faf5f2]'>
      ...
      <form className='flex items-center border-b border-b-[#8d8d8d] sm:border-b-[#000]'>
        ...
        <input type="search" onChange={handleSearch} name="search-bar" id="search-bar" placeholder='type to search' className='text-[#8d8d8d] w-full bg-transparent border-0 focus:ring-0' />
      </form>
    </div>
  )
}
