  ...
  return (
    <div className='flex gap-[1px] sm:gap-3 items-center sm:pr-4'>
        <span className='cursor-pointer'>
            <User className='w-8 h-8 sm:w-[40px] sm:h-[40px]' aria-hidden={true} />
        </span>
        <span className='cursor-pointer relative'>
            <Heart className='w-6 h-6 sm:w-[30px] sm:h-[30px]' aria-hidden={true}  />
        </span>
        <span className='cursor-pointer relative'>
            <Cart className='w-6 h-6 sm:w-[30px] sm:h-[30px]' aria-hidden={true}  />
            <span className='absolute bg-[#69727d] bottom-3 left-4 flex justify-center items-center px-2 py-[2.5px] rounded-full'>
