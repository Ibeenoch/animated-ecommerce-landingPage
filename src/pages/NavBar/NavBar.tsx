              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="-mr-2 flex md:hidden">
                    {/* Mobile menu button */}
                    <Disclosure.Button className="relative inline-flex items-center justify-center bg-white p-2 text-gray-800 hover:text-gray-900 focus:outline-none focus:ring-0 focus:ring-white focus:ring-offset-0">
